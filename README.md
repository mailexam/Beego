...
Minimal [Beego](https://beego.vip/) example that sends test mail through [Mailexam](https://mailexam.io/) SMTP via the Go standard library [`net/smtp`](https://pkg.go.dev/net/smtp).
...
| Host | `{MAILEXAM_LOGIN}.mailexam.io` (built in `mail.go`) |
